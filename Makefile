...
release:
	...
	kustomize build manifests/base/ | sed "s|${DOCKER_REPO}/${APPLICATION_NAME}|${DOCKER_REPO}/${APPLICATION_NAME}:${RELEASE_VERSION}|g"  >> ${APPLICATION_NAME}-${RELEASE_VERSION}.yaml